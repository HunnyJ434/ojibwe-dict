...
export const Navbar = () => {
    return (
        <div className={`${inter.className} flex justify-between w-[100%] h-[3.5rem] bg-[orange]`}>
			{/* buttons */}
			<Link href="/"><Image src={mainIcon.src} alt="website Icon" width={50} height={25} className="ml-3 w-[2.5rem] h-[3.5rem]"></Image></Link>
