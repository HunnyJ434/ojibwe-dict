...
export default function Page() {
	...
	return (
		...
		<form className="rounded-lg  w-[50%]  flex flex-col border-[1px] border-[black]" action={handleSubmit}>
		...
		<div className="flex"><h1 className="w-[28%] pb-1 text-[orange]  duration-1000 text-3xl ml-3 border-b-[3px] mr-[-0.7rem] border-[orange]">Suggest Tex</h1><h1 className="m-0 animate-bounce text-3xl text-[orange]">t</h1></div>
		...
		<input className="rounded-md h-[2.5rem] w-[100%] bg-[#d3def0] hover:bg-[#b2ebc1] transition-all hover:translate-y-[-0.3rem] hover:shadow-lg duration-1000 border-b-[8px] border-b-[#e1e9f5]" type="submit"></input>
		</form>
		<Image 
    src={bg.src}
    fill
